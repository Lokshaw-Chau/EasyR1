...
def smart_resize(height, width, factor=28, min_pixels=56 * 56, max_pixels=6400*28*28, max_long_side=8192):
    """缩放后图片满足以下条件:
    1. 长宽能被 factor 整除
...
def update_image_size_(image_ele: dict, min_tokens=1, max_tokens=6400, merge_base=2, patch_size=14):
